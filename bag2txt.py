...
class ImageCreator():
    ...
    def __init__(self):
        ...
        #---bag part---
        with rosbag.Bag('2.bag', 'r') as bag: #open first .bag
            print("6.bag")
            for topic,msg,t in bag.read_messages():
                #print topic
                if topic == "/super_pi03/joy_mapper_node/car_cmd": #change ros_master name from aiplus1 to your duckiebot's name
                    #print topic, msg.header.stamp
                    self.omega = msg.omega
                    self.v = msg.v
                    self.t = 1
                elif topic == "/super_pi03/camera_node/image/compressed":
                    if self.t == 1:
                        try:
                            #print topic, msg.header.stamp
